...
# Load YOLO models
bottle_model = YOLO("F:/BE_Project/Final Year Project 2025/last-project/backend/yolov8n.pt")  # Pre-trained model for bottle detection
defect_model = YOLO("F:/BE_Project/Final Year Project 2025/last-project/backend/best.pt")      # Custom-trained model for defect detection
